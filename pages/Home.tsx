    ...
    <div>
      ...
      <section className="relative h-[80vh] w-full bg-[#2D2A26] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto space-y-8">
          ...
          <div className="pt-8">
            <Button onClick={() => onNavigate(ViewState.SHOP)} className="bg-[#F9F8F4] text-[#2D2A26] hover:bg-[#E5E0D8] border-none shadow-lg">
              Explore Collection
            </Button>
          </div>
        </div>
      ...
      <section className="py-20 bg-[#F2EFE9] border-t border-[#E5E0D8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-12">
            ...
            <Button variant="outline" onClick={() => onNavigate(ViewState.SHOP)}>View All</Button>
          </div>
